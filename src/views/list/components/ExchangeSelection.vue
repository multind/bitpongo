        ...
        <nut-row type="flex" flex-wrap="nowrap" style="border: #999">
          <nut-col span="12">
            <nut-space direction="vertical" :style="{ '--nut-space-gap': '0px' }">
              <text style="font-size: 10px; color: #2f2f2f">{{ t('exchangeSelection.exchangeLabel') }}</text>
              <text style="font-size: 13px">{{ getExchangeName(item.exchange) }}</text>
            </nut-space>
          </nut-col>
          <nut-col span="12">
            <nut-space direction="vertical" :style="{ '--nut-space-gap': '0px' }">
              <text style="font-size: 10px; color: #2f2f2f">{{ t('exchangeSelection.apiKeyLabel') }}</text>
